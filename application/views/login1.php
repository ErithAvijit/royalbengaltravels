...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>logpop/bootstrap/css/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="/logpop/font-awesome/css/font-awesome.min.css" />

    <script type="text/javascript" src="<?php echo base_url();?>logpop/js/jquery-1.10.2.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>logpop/bootstrap/js/bootstrap.min.js"></script>
</head>
<body>
...
<!-- <div class="container pb-modalreglog-container">
    <div class="row">
        <div class="col-xs-12 col-md-4 col-md-offset-4">
             <legend class="pb-modalreglog-legend">..</legend> ......text... -->
            <div class="input-group pb-modalreglog-input-group">
                <button class="btn btn-primary pb-modalreglog-submit" data-toggle="modal" data-target="#myModal">Booking</button>
    ...
    <div class="pb-modalreglog-footer">
        <!-- <p>Design provided by <a href="https://www.pre</a></p> -->
    </div>
</div>
